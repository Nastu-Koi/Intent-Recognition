    ...
    try:
        ...
        if checkpoint_tuple:
            ...
            restored_state = {
                ...
                "eval_confidence": channel_values.get("eval_confidence", 1.0),
                "eval_arbitration": channel_values.get("eval_arbitration", {}),
...
async def chat(request: ChatRequest):
    ...
    initial_state = {
        ...
        "eval_confidence": checkpoint_state.get("eval_confidence", 1.0),
        "eval_arbitration": checkpoint_state.get("eval_arbitration", {}),
